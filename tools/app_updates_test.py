...
class AppUpdatesTest(unittest.TestCase):
    ...
    def test_update_info_uses_github_release_url(self):
        info = update_info_from_release(
            {
                "tag_name": "v3.0.2",
                "html_url": "https://github.com/gurjar1/OmniDictate/releases/tag/v3.0.2",
            },
            current_version="3.0.1",
        )

        self.assertTrue(info.update_available)
        self.assertEqual(info.latest_version, "v3.0.2")
        self.assertIn("/releases/tag/v3.0.2", info.release_url)

    def test_current_patch_release_does_not_update_to_itself(self):
        self.assertEqual(APP_VERSION, "3.0.2")
        info = update_info_from_release(
            {
                "tag_name": "v3.0.2",
                "html_url": "https://github.com/gurjar1/OmniDictate/releases/tag/v3.0.2",
